...
GasCO2_HeatPumpHVAC_res <- 
  generate_qtrly_npv_2(kWh_LS_QRT, ClimateZone, EU_HP_HVAC, 
                     EUL_Claims_HeatPumpHVAC_res, Divider_discount,
                     Gas_kwhe_HVAC)

GasCO2_HPWH_res <- 
  generate_qtrly_npv_2(kWh_LS_QRT, ClimateZone, EU_HPWH, EUL_Claims_HPWH_res,
                     Divider_discount, Gas_kwhe_HPWH)

GasCO2_HeatPumpHVAC_res_new <- 
  generate_qtrly_npv_2(kWh_LS_QRT, ClimateZone, EU_HP_HVAC, 
                     EUL_New_HeatPumpHVAC_res, Divider_discount,
                     Gas_kwhe_HVAC)

GasCO2_HPWH_res_new <- 
  generate_qtrly_npv_2(kWh_LS_QRT, ClimateZone, EU_HPWH, EUL_New_HPWH_res,
                     Divider_discount, Gas_kwhe_HPWH)

#Calculate Total Gas Benefits
Calc_GasBen_HeatPumpHVAC_res <-  GasCO2_HeatPumpHVAC_res+ GasComTD_HeatPumpHVAC_res
Calc_GasBen_HPWH_res <- GasCO2_HPWH_res + GasComTD_HPWH_res
...
knitr::kable(TRC_IMPACT, caption = "Average Total Resource Costs (TRC) for Fuel-Sub Measures",
             col.names = c("Measure", "TRC Claims", "TRC, Increased from EUL Study","TRC, Increased from Bill Impacts", "TRC, Decreased from Infra Cost"))
```
